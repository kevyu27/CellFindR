...
knitr::opts_knit$set(root.dir = "/Users/kyu/Desktop/CellFindR_2.0/TM_Epi/")
...
Now, please try and load the data, if you have a Seurat object already processed, or if you need a fresh 10x install use the load_data function. 
For this case, I will be demoing a mouse TM epithelium dataset
```{r}
library(Seurat)
library(dplyr)
library(stringr)
...
proj_name <- 'TM'
```
## set working directory of output data and view datta
```{r}
setwd(file_loc)
...
## create output folder and run data
